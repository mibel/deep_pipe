    ...
    def load_mscan(self, patient_id):
            ...
            for modalities in ['pre/FLAIR.nii.gz', 'pre/T1.nii.gz']: # reg_t1.nii.gz
                ...
                if 'FLAIR' in modalities:
                    tmp_img_path = self.idx_to_path['57']
                    b = nib.load(tmp_img_path + '/pre/FLAIR.nii.gz').get_data().astype('float32')
                    m = nib.load(tmp_img_path + '/pre/brainmask_T1_mask.nii.gz').get_data().astype('float32')
                    b[m==0]=0
